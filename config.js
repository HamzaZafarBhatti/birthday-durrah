var config = {
    ...
    texts: [
        "صديقي العزيز والمبرمج المحترف حمزة",
        "شكرًا جزيلًا لك على ما قدمت لي",
        "أتمنى لك حياة حافلة بالنجاح",
        "أطلب أمنية!📬",
        "أتمنى أن تتحقق أمنياتك جميعها",
        "وأن يمنحك الله عمرًا طويلًا وأنت بصحة وعافية",
        "شكرًا لأنك بقيت صديقًا رائعًا
      "أتمنى أن تكون موجود دائمًا."
        🐈🐈‍⬛
    ],
    /**
